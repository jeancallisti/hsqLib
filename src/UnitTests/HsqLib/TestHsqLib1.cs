...
namespace UnitTests
{
    ...
    public class TestHsqLib1
    {
        ...
        public void CanUncompressFileWithoutRepeatedData()
        {
            ...
            Assert.That(output.Count, Is.EqualTo(output_bytes.Length));
            Assert.AreEqual(output_bytes, output);
        }

        [Test]
        public void CanUncompressFileWithoutRepeatedDataMultipleInstructions()
        {
            var input_bytes = new byte[]
            {
        ...
        [Test]
        public void CanUncompressWithMethodZero_Lenght2()
        {
            var input_bytes = new byte[]
            {
        ...
        [Test]
        public void CanUncompressWithMethodZero_Lenght5()
        {
            var input_bytes = new byte[]
            {
        ...
        [Test]
        public void CanUncompressWithMethodZeroWhenInstructionsAreSplitUp()
        {
            var input_bytes = new byte[]
            {
        ...
        [Test]
        public void CanUncompressWithMethodOne()
        {
            var input_bytes = new byte[]
            {
        ...
        [Test]
        public void CanUncompressWithMethodOneUsingAlternativeLengthByte()
        {
            var input_bytes = new byte[]
            {
                0x17, 0x00, 0x13, 0x00, 0x00, 0x83, // Header (checksum wrong)
        ...
        [Test]
        public void CanUncompressWithMethodOneAndEofMarker()
        {
            var input_bytes = new byte[]
            {
                0x17, 0x00, 0x13, 0x00, 0x00, 0x83, // Header (checksum wrong)
        ...
        [Test]
        public void CanUncompressWithMethodOneWhereLengthIsGreaterThanDistance()
        {
            var input_bytes = new byte[]
            {
                0x17, 0x00, 0x13, 0x00, 0x00, 0x83, // Header (checksum wrong)
